  ...
  if (!mounted) {
    return (
      <div className="relative">
        <button
          className="relative inline-flex items-center justify-center w-12 h-6 rounded-full bg-gradient-to-r from-gray-200 to-gray-300 transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background"
          aria-label="Theme switcher"
          title="Theme switcher"
        >
          {/* Switch knob */}
          <div className="absolute w-5 h-5 rounded-full bg-white shadow-md transform translate-x-0.5 scale-100" />
